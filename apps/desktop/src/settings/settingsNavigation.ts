...
export const preferenceSections: readonly SettingsSection[] = [
  ...
  { id: "ai", label: "AI", description: "API 키 연결과 기본 모델 선택", icon: Sparkles,
    keywords: ["API key", "API 키", "Model", "모델", "Gateway", "Provider", "제공자", "Chat", "채팅", "OpenAI", "Anthropic", "Google"] },
  { id: "dictation", label: "음성 받아쓰기", description: "Whisp 녹음, STT 모델과 자동 입력", icon: Mic, keywords: ["dictation", "Whisp", "voice", "speech", "STT", "받아쓰기", "녹음", "전사", "마이크", "파형", "whisper", "Groq", "xAI"] },
