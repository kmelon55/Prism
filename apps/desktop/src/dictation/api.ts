...
export interface DictationStatus {
  phase: "idle" | "preparing" | "recording" | "transcribing" | "inserting" | "success" | "error" | "preview";
...
export const defaultSettings: DictationSettings = { ...recordingDefaults, defaultDelivery: "paste", provider: "local", model: "", baseURL: "", language: "auto", prompt: "", vocabulary: [], whisperPath: "/opt/homebrew/bin/whisper-cli", modelPath: "", uiLanguage: "ko", showRecordingShortcutHints: true, showTranscriptionStatus: true };
...
export const dictationAction = (action: "status" | "cancel" | "preview" | "copy" | "microphoneSettings" | "microphoneRequest", previewSettings?: DictationSettings) => invoke<DictationStatus>("dictation_action", { action, ...(previewSettings ? { previewSettings } : {}) });
